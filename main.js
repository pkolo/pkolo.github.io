...
var _user$project$NewStyle$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _mdgriffith$style_elements$Style_Color$background(_user$project$NewStyle$colors.white),
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Style_Font$typeface(
							{
								...
								_0: _mdgriffith$style_elements$Style_Font$importUrl(
									{name: 'Didact Gothic', url: 'https://fonts.googleapis.com/css?family=Didact+Gothic'}),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Font$size(52),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Font$lineHeight(1.25),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _mdgriffith$style_elements$Style_Color$text(_user$project$NewStyle$colors.darkGrey),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _mdgriffith$style_elements$Style_Color$text(_user$project$NewStyle$colors.blue),
												_1: {
													ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												_user$project$NewStyle$Tag,
												{
													...
													_0: _mdgriffith$style_elements$Style$hover(
														{
															ctor: '::',
															_0: _mdgriffith$style_elements$Style_Color$text(_user$project$NewStyle$colors.pink),
															_1: {
																ctor: '::',
											...
											_1: {
												...
												_0: A2(
													_mdgriffith$style_elements$Style$style,
													_user$project$NewStyle$ActiveTag,
													{
														ctor: '::',
														_0: _mdgriffith$style_elements$Style_Color$text(_user$project$NewStyle$colors.pink),
														_1: {ctor: '[]'}
												...
												_1: {
													...
													_0: A2(
														_mdgriffith$style_elements$Style$style,
														_user$project$NewStyle$Active,
														{
															ctor: '::',
															_0: _mdgriffith$style_elements$Style_Color$text(_user$project$NewStyle$colors.green),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															_mdgriffith$style_elements$Style$style,
															_user$project$NewStyle$InProgress,
															{
																ctor: '::',
																_0: _mdgriffith$style_elements$Style_Color$text(_user$project$NewStyle$colors.yellow),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																_mdgriffith$style_elements$Style$style,
																_user$project$NewStyle$Inactive,
																{
																	ctor: '::',
																	_0: _mdgriffith$style_elements$Style_Color$text(_user$project$NewStyle$colors.red),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
